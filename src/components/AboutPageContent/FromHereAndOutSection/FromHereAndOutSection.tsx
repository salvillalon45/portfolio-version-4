	...
	return (
		<section id='from-here-and-out-section' className='grid gap-4'>
			...
			<div className='grid gap-6 w-9/12 mx-auto'>
				...
				<Text>
					✅ Management Leadership for Tomorrow. I was a Career Prep
					fellow and graduated in the top 5% of my class.
				</Text>

				<Text>
					✅ Society of Hispanic Professional Engineers (SHPE-UCI).
					SHPE-UCI was a big part of my college experience. I became a
					general member, then secretary, then External Vice
					President, then President (Being president was one of the
					best things I have ever done!). During the year I served as
					President, SHPE-UCI received 13 awards and won the coveted
					National Medium Chapter of the Year award, beating 245
					chapters across the U.S. for the first time in SHPE-UCI
					history.
				</Text>

				<Text>
					✅ I completed 6 Software Engineering internships at S&P Dow
					Jones Indices, UCI Student Life and Leadership, JP Morgan
					Chase & Co, Vusar, Dreams For Schools, and FinityOne.
				</Text>
			...
			<div className='grid gap-4'>
				...
				<Text style='justify-self-center'>
					S&P Dow Jones Indices Internship in New York! First in my
					family to explore New York.
				</Text>
			</div>
			...
			<div className='grid gap-4'>
				<div className='flex gap-8 justify-center'>
					...
					<img className='w-2/5' src={BoardMembers} alt='' />
				</div>
				<Text style='justify-self-center'>
					National Convention 2020 (Left). SHPE-UCI 2018-2019 board
					members (Right). SHPE-UCI played a big part of my life.
				</Text>
			</div>
			...
			<div className='grid gap-4'>
				<div className='flex gap-8 justify-center'>
					<img className='w-2/5' src={Squat} alt='' />
					<img className='w-2/5' src={Sitting} alt='' />
				</div>
				<Text style='justify-self-center'>
					National Convention 2020 (Left). SHPE-UCI 2018-2019 board
					members (Right). SHPE-UCI played a big part of my life.
